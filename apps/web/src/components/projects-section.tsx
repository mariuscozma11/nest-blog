...
const mockProjects: Project[] = [
  ...
  },
  {
    ...
    fullDescription: "Collaborated with an associate to develop features for a scheduling and client management app for barbershops, clinics, and service businesses. Built booking management interface with Next.js and TailwindCSS, implemented real-time calendar with drag-and-drop scheduling, and created Supabase edge functions for appointment logic and notifications. 1k+ monthly active users.",
  ...
  },
  {
    ...
    fullDescription: "Collaborated with an associate to develop a gym membership mobile app for Gym One, a franchise in Timisoara. Built user dashboard and membership tracking screens in React Native, implemented QR check-in flow for gym entry, designed RESTful API endpoints for membership management using NestJS, and helped design database schema for users and subscriptions in PostgreSQL. 10k+ monthly active users.",
